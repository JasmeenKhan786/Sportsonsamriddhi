...
export default class CoachDetail extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      availability: this.props.navigation.getParam('details')['availability'],
      ...
      fee: this.props.navigation.getParam('details')['fee'],
      gender: this.props.navigation.getParam('details')['gender'],
      mobileNumber: this.props.navigation.getParam('details')['mobileNumber'],
      name: this.props.navigation.getParam('details')['name'],
      socialMediaLink:
        this.props.navigation.getParam('details')['socialMediaLink'],
      sport: this.props.navigation.getParam('details')['sport'],
      website: this.props.navigation.getParam('details')['website'],
      image: this.props.navigation.getParam('details')['image'],
      rating: this.props.navigation.getParam('details')['ratings'],
      age: '',
      myMobileNumber: 0,
      myName: '',
      myAge: 0,
        ...
        <Header
          ...
          leftComponent={
            <Icon
              name="arrow-back"
              color="white"
              onPress={() => this.props.navigation.navigate('CoachScreen')}
            />
          }
          centerComponent={{
              ...
              <View
                ...
                <View
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      this.props.navigation.navigate('RateCoachScreen', {
